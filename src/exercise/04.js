  ...
  return (
    ...
    <ul {...getMenuProps({ref: listRef})}>
      {/*
        ...
        🦉 ensures that the scrollable area of the <ul /> is the same height it would be if it rendered everything
      */}
...
function App() {
  ...
  // 🐨 create a listRef with React.useRef which will be used for the parentRef option you
  // pass to useVirtual and should be applied to the <ul /> for our menu. This is how react-virtual
    ...
    <div className="city-app">
      ...
      <div>
        ...
        <Menu
          ...
          // 🐨 pass the props that we added to Menu component:
          listRef={listRef}
